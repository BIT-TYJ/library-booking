...
if __name__ == '__main__':
    ...
    while 1:
        driver.get(url)
        driver.find_element_by_id("phone").send_keys("18800186387")
        driver.find_element_by_id("pwd").send_keys("a13956621590")
        login=driver.find_element_by_class_name("margin-btm24" ) #根据id找到登录按钮
        login.click()
        time.sleep(4)
